var Snoopy = function(snoopyData){
	snoopyData.forEach(function(obj){ obj['group'] = '0';});
	

	// DOM element where the Timeline will be attached
	var container = document.getElementById("snoopyData");

	// Create a DataSet (allows two way data-binding)
	var dataNames = ['snoopy'];
	var groups = new vis.DataSet();
	
    groups.add({id: 0, content: dataNames[0]});

	this.items = new vis.DataSet(snoopyData);
...
Snoopy.prototype.getDataset = function(){
	return this.items;
}

Snoopy.prototype.setTimelineWindow = function(start,end){
