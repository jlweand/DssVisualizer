...
class PyKeyPressTest(unittest.TestCase):
    ...
    def test_fixedData(self):
        ...
        # insert Fixed Data
        modifiedCount = PyKeyPress().modifyFixedKeyPressData(dataId, '11111', '[New Content Added]', 'Keypresses', '2016-10-15 17:58:31', True)
        ...
        # update Fixed Data
        modifiedCount = PyKeyPress().modifyFixedKeyPressData(dataId, '222222', '[Edited Content Added]', 'Keypresses123', '2016-10-02 18:28:00', False)
        jsonData = PyKeyPress().selectKeyPressDataById(dataId)
        self.assertEqual(1, modifiedCount)
