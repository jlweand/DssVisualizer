...
class MultiExcludeThroughputTest(unittest.TestCase):
    ...
    def test_fixedData(self):
        ...
        modifiedCount = MultiExcludeThroughput().insertFixedMultiExcludeThroughputData(dataId, 123, '2016-10-02 18:28:00', 1111, True)
        ...
        modifiedCount = MultiExcludeThroughput().updateFixedMultiExcludeThroughputData(dataId, 456, '2017-01-02 18:28:00', 99999, False)
        self.assertEqual(1, modifiedCount)
        jsonData = MultiExcludeThroughput().selectMultiExcludeThroughputDataById(dataId)
