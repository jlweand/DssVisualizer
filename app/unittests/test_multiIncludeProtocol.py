...
class MultiIncludeProtocolTest(unittest.TestCase):
    def test_monolithicTestCase(self):
        ...
        modifiedCount = MultiIncludeProtocol().insertFixedMultiIncludeProtocolData(dataId, '1111', '29 p/s', 'traffic',
                                                                                   'new stuff',
                                                                                   '2016-12-02 18:28:00')
        self.assertEqual(1, modifiedCount)

        # update Fixed MultiExcludeProtocol Data
        modifiedCount = MultiIncludeProtocol().updateFixedMultiIncludeProtocolData(dataId, '7777', '2 p/s', 'traffic',
                                                                                   'updated stuff',
                                                                                   '2016-10-02 18:28:00')
        self.assertEqual(1, modifiedCount)
